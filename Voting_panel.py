...
def votingPg(root,frame1,client_socket):
    ...
    Radiobutton(frame1, text = "BJP\n\nNarendra Modi", variable = vote, value = "bjp", indicator = 0, height = 4, width=20, command = lambda: voteCast(root,frame1,"bjp",client_socket)).grid(row = 2,column = 1)
    ...
    Radiobutton(frame1, text = "Congress\n\nRahul Gandhi", variable = vote, value = "cong", indicator = 0, height = 4, width=20, command = lambda: voteCast(root,frame1,"cong",client_socket)).grid(row = 3,column = 1)
    ...
    Radiobutton(frame1, text = "Aam Aadmi Party\n\nArvind Kejriwal", variable = vote, value = "aap", indicator = 0, height = 4, width=20, command = lambda: voteCast(root,frame1,"aap",client_socket) ).grid(row = 4,column = 1)
    ...
    Radiobutton(frame1, text = "Shiv Sena\n\nUdhav Thakrey", variable = vote, value = "ss", indicator = 0, height = 4, width=20, command = lambda: voteCast(root,frame1,"ss",client_socket)).grid(row = 5,column = 1)
    ...
    Radiobutton(frame1, text = "Telugu Desam Party\n\nChandra Babu Naidu", variable = vote, value = "tdp", indicator = 0, height = 4, width=20, command = lambda: voteCast(root,frame1,"tdp",client_socket)).grid(row = 6,column = 1)
    ssLogo = ImageTk.PhotoImage((Image.open("img/tdp.jpg")).resize((50,45),Image.ANTIALIAS))
    ssImg = Label(frame1, image=ssLogo).grid(row = 6,column = 0)

    Radiobutton(frame1, text = "\nNOTA    \n  ", variable = vote, value = "nota", indicator = 0, height = 4, width=20, command = lambda: voteCast(root,frame1,"nota",client_socket)).grid(row = 7,column = 1)
